		...
		<div class="container">
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${id == null && admin == null}">
				 <li class="nav-item"><a class="nav-link active" aria-current="page" style="margin: 0 25px 0 0px;" href="../user/login.do">LOGIN</a></li>
				</c:if>
				<c:if test="${id != null }">
				 <li class="nav-item"><a class="nav-link active" aria-current="page" style="margin: 0 25px 0 0px;" href="../user/logout.do">LOGOUT</a></li>
				</c:if>
				<c:if test="${admin != null }">
				 <li class="nav-item"><a class="nav-link active" aria-current="page" style="margin: 0 25px 0 0px;" href="../user/logout.do">LOGOUT</a></li>
				 <li class="nav-item"><a class="nav-link active" aria-current="page" style="margin: 0 25px 0 0px;" href="../user/list.do">관리자페이지</a></li>
				</c:if>
			</ul>
		</div>
	</nav>
...
<input type="hidden" name="rboard_seq" value="${dto.rboard_seq }"/>
		<div>
		<div class="form-group" align="center">
		   <label for="exampleFormControlInput1" style="text-align: left;">제목</label>
		   <input type="text" class="form-control" name="rboard_title" value="${dto.rboard_title }" width="100%"/>
		</div>
		<div class="form-group" align="center">
			<label for="exampleFormControlInput1">글쓴이</label>
			<input type="text" class="form-control" name="rboard_writer" value="${dto.rboard_writer }" readOnly />
		</div> 
		<div class="form-group" align="center">
			<label for="exampleFormControlInput1">내용</label>
			<textarea class="form-control" name="rboard_content" rows="10">${dto.rboard_content }</textarea>
		</div>
		<div class="form-group" align="center">
			<label for="exampleFormControlInput1">평점</label>
			<input type="text" class="form-control" name="rboard_grade" value="${dto.rboard_grade }" />
		</div>
		
		
		<div class="form-group" align="center">
		<button id="submitBtn" type="submit" class="btn btn-secondary">수정완료</button>
</form>
