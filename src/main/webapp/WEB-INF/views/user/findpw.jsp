...
<c:if test="${ check == 0 }">
		<script>
		swal("Notice","비밀번호가 존재하지 않습니다!");
		</script>
</c:if>
<c:if test="${ check == 1 }">
		<script>
		swal("Notice","비밀번호가 존재합니다!");
		</script>
</c:if>
<!-- Responsive navbar-->
   ...
   <div class="signup-form" >
      <form action="" method="post" class="form-horizontal" >
         ...
         <div class="form-group row" style="width:400px; margin-left:100px;">
            <button class="btn btn-primary btn-lg" type="submit" id="submit" style="width:10px; height:35px; margin-right:30px;">비밀번호찾기</button>&nbsp;&nbsp;
      ...
      <div class="text-center"><a href="findId.do">아이디찾기</a></div>
   </div>
   <!-- Footer-->
	<footer class="footer"
